...
import org.league2.factory.MyHibernateFactory;
import org.league.model.League;
...
public class MyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			Session session=MyHibernateFactory.getHibernateSession();
